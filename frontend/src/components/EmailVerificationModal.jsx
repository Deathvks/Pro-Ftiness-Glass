...
const EmailVerificationModal = ({ currentEmail, onEmailUpdated, onCodeSent }) => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-bg-primary p-4 animate-[fade-in_0.5s_ease-out] !pt-[calc(1rem+var(--safe-top))] !pb-[calc(1rem+var(--safe-bottom))]">
