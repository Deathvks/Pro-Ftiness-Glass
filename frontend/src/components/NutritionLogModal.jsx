...
const NutritionLogModal = ({ mealType, onClose, onSave, logToEdit, isLoading }) => {
    ...
    if (selectedDetailItem) {
        return (
            <div className="fixed inset-0 z-[100] flex items-center justify-center bg-black/60 backdrop-blur-md p-4 animate-[fade-in_0.2s_ease-out] !pt-[calc(1rem+var(--safe-top))] !pb-[calc(1rem+var(--safe-bottom))]">
    ...
    return (
        <>
            <div className="fixed inset-0 z-[60] flex items-center justify-center bg-black/60 backdrop-blur-md animate-[fade-in_0.3s_ease-out] p-4 sm:p-0 pb-12 md:pb-0 !pt-[calc(1rem+var(--safe-top))] !pb-[calc(1rem+var(--safe-bottom))]">
