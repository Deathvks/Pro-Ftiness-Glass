...
const FoodScannerModal = ({ onClose, onScanComplete }) => {
    ...
    return (
        <div className="fixed inset-0 z-[200] flex items-center justify-center p-4 bg-black/60 backdrop-blur-md animate-[fade-in_0.2s_ease-out]">
            <div className="absolute inset-0" onClick={!isScanning ? onClose : null} />
            <GlassCard className="glass w-full max-w-md p-6 relative z-10 animate-[slide-up_0.3s_ease-out] rounded-[32px] border border-glass-border shadow-2xl flex flex-col items-center">
