...
const TourGuide = () => {
    ...
    useEffect(() => {
        ...
        /* 1. Base de la flecha (actúa como el borde blanco) */
        ...
        .driver-popover-arrow-side-left.driver-popover-arrow {
          border-left-color: var(--glass-border) !important; /* Color Borde */
          border-right-color: transparent !important;
          border-top-color: transparent !important;
          border-bottom-color: transparent !important;
        }
        .driver-popover-arrow-side-left.driver-popover-arrow::after {
          border-left-color: var(--bg-secondary); /* Color Fondo */
          right: 2px; /* Desplazamiento para mostrar el borde */
          top: -8px;
        }
