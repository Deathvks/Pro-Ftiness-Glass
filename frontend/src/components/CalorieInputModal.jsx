...
const CalorieInputModal = ({ estimatedCalories, onComplete, onCancel, isSaving }) => {
  ...
  return (
    <div
      className="fixed inset-0 z-[60] flex items-center justify-center bg-black/60 backdrop-blur-sm animate-[fade-in_0.3s_ease-out] !pt-[calc(1rem+var(--safe-top))] !pb-[calc(1rem+var(--safe-bottom))]"
      onClick={onCancel}
    >
      <div
