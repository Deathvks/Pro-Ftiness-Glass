...
const CreatinaTracker = ({ onClose, selectedDate }) => {
  ...
  return (
    <>
            <ModalPortal><div className="fixed inset-0 bg-black/60 backdrop-blur-md flex items-center justify-center p-4 z-[100] animate-[fade-in_0.2s_ease-out] !pt-[calc(1rem+var(--safe-top))] !pb-[calc(1rem+var(--safe-bottom))]">
            ...
            {/* Modal de Edición */}
            {showEditModal && editingLog && <ModalPortal>
