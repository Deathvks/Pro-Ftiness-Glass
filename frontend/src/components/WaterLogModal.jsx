...
const WaterLogModal = ({ initialQuantity = 0, onSave, onClose, isLoading }) => {
  ...
  return (
    <div
      className="fixed inset-0 z-[100] flex items-center justify-center bg-black/60 backdrop-blur-md animate-[fade-in_0.2s_ease-out] p-4 !pt-[calc(1rem+var(--safe-top))] !pb-[calc(1rem+var(--safe-bottom))]"
      onClick={onClose}
    >
      <div
