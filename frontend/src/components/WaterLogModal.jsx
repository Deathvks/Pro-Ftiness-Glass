...
const WaterLogModal = ({ initialQuantity = 0, onSave, onClose, isLoading }) => {
  ...
  return <ModalPortal>
    <div
      className="fixed inset-0 z-[100] flex items-end sm:items-center justify-center p-0 sm:p-4 bg-black/60 backdrop-blur-md animate-[fade-in_0.2s_ease-out]"
      onClick={onClose}>
      
      <div
        className="relative w-full max-w-sm p-8 mt-auto sm:mt-0 pb-[calc(2rem+var(--safe-bottom))] sm:pb-8 sm:m-4 text-center bg-bg-primary rounded-t-[32px] rounded-b-none sm:rounded-[32px] ring-1 ring-black/5 dark:ring-white/10 shadow-2xl animate-[slide-up_0.3s_ease-out] sm:animate-[slide-up_0.3s_ease-out]"
        onClick={(e) => e.stopPropagation()}>

        {/* Drag handle for mobile */}
        <div className="w-12 h-1.5 bg-black/10 dark:bg-white/20 rounded-full mx-auto mt-3 mb-2 sm:hidden shrink-0" />
