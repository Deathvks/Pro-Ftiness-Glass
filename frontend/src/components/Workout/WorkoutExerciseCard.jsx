    ...
    <div className="p-4 sm:p-6 relative flex flex-col gap-6 sm:gap-8">
      ...
      <button
        ...
        <ExerciseMedia
          details={exercise}
          fitMode="cover"
          className="w-full lg:max-w-lg mx-auto mb-2 transition-all rounded-[24px] overflow-hidden relative" />
      ...
      {/* --- MODAL RECORDATORIO --- */}
      {showReminderInput && <ModalPortal>
        <div className="fixed inset-0 z-[100] flex items-end sm:items-center justify-center p-0 sm:p-4 pt-[calc(1rem+var(--safe-top))] bg-black/60 backdrop-blur-md animate-[fade-in_0.2s_ease-out]">
          <div className="absolute inset-0" onClick={() => setShowReminderInput(false)} />
          <div
            onClick={(e) => e.stopPropagation()}
            className="glass bg-bg-primary w-full max-w-sm p-6 sm:p-8 pb-[max(1.5rem,var(--safe-bottom))] sm:pb-8 rounded-t-[32px] sm:rounded-[32px] rounded-b-none sm:rounded-b-[32px] shadow-2xl relative z-10 animate-[slide-up_0.3s_ease-out] border-none ring-1 ring-black/5 dark:ring-white/10">
