...
const WorkoutExerciseCard = ({
  ...
  return (
    <div className="p-4 sm:p-6 relative flex flex-col gap-6 sm:gap-8">
      ...
      {/* --- MODAL RECORDATORIO --- */}
      {showReminderInput && (
        <div className="fixed inset-0 z-[100] flex items-end sm:items-center justify-center p-0 sm:p-4 bg-black/60 backdrop-blur-md animate-[fade-in_0.2s_ease-out] !pt-[calc(1rem+var(--safe-top))] !pb-[calc(1rem+var(--safe-bottom))]">
