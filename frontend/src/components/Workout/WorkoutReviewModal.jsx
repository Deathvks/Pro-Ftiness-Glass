...
const WorkoutReviewModal = ({ onClose, onConfirm, isSaving }) => {
  ...
  return <ModalPortal>
    <div className="fixed inset-0 z-[100] flex items-end sm:items-center justify-center p-0 sm:p-4 bg-black/80 backdrop-blur-sm animate-[fade-in_0.25s_ease-out]">
            
            {/* 2. Modal Isla: max-h-[70vh] garantiza que jamás colisione con los bordes de la pantalla */}
            <div className="relative w-full max-w-lg md:max-w-2xl rounded-t-[32px] rounded-b-none sm:rounded-2xl bg-bg-secondary border border-glass-border shadow-2xl flex flex-col max-h-[70vh] md:max-h-[85vh] animate-[slide-up_0.2s_ease-out] sm:animate-[scale-in_0.2s_ease-out] overflow-hidden shrink-0">
