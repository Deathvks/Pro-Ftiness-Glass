...
const WorkoutHeatmapModal = ({ exercises = [], onClose }) => {
  ...
  return (
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 pb-[calc(6rem+var(--safe-bottom))] md:pb-4 bg-black/60 backdrop-blur-sm animate-[fade-in_0.2s_ease-out] !pt-[calc(1rem+var(--safe-top))] !pb-[calc(1rem+var(--safe-bottom))]">
