...
  // --- FUNCIÓN MANUAL (Sin cambios, ya estaba correcta) ---
  const handleAddManualExercise = () => {
    const exerciseName = t('exercise_ui:manual_exercise_name', 'Ejercicio Manual');
...
      equipment: 'other', 
      is_manual: true,
      image_url_start: null, // Importante para que el hook funcione
      image_url_end: null,   // Importante para que el hook funcione
    };
...
        // Conectamos la función del botón
