...
const ExerciseSearch = ({
  ...
  return (
    <div className="fixed inset-0 z-50 bg-bg-primary flex justify-center items-center animate-[fade-in_0.2s_ease_out] !pt-[calc(1rem+env(safe-area-inset-top,24px))]">
