...
const PixabayModal = ({ isOpen, onClose, onSelectImage }) => {
  ...
  return <ModalPortal>
    <div className="fixed inset-0 z-[100] flex items-end sm:items-center justify-center bg-black/80 backdrop-blur-sm p-0 sm:p-4 animate-in fade-in duration-200">
            <div className="bg-bg-secondary border border-glass-border w-full max-w-3xl mt-auto sm:mt-0 rounded-t-[32px] rounded-b-none sm:rounded-2xl pb-[calc(2rem+var(--safe-bottom))] sm:pb-0 shadow-2xl flex flex-col max-h-[85vh] overflow-hidden animate-[slide-up_0.3s_ease-out] sm:animate-none">
