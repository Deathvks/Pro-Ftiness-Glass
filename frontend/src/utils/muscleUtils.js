...
export const DB_TO_HEATMAP_MAP = {
    ...
    // Cabezas específicas y Divisiones
    'deltoides anterior': ['front-deltoids'],
    'deltoides medio': ['front-deltoids', 'back-deltoids'],
    'deltoides posterior': ['back-deltoids'],
    'bíceps cabeza corta': ['biceps'],
    'biceps cabeza corta': ['biceps'],
    'bíceps cabeza larga': ['biceps'],
    'biceps cabeza larga': ['biceps'],
    'tríceps cabeza larga': ['triceps'],
    'triceps cabeza larga': ['triceps'],
    'tríceps cabeza lateral': ['triceps'],
    'triceps cabeza lateral': ['triceps'],
    'tríceps cabeza medial': ['triceps'],
    'triceps cabeza medial': ['triceps'],
...
export const MUSCLE_NAMES_ES = {
    ...
    'bíceps cabeza corta': 'Bíceps Cabeza Corta',
    'biceps cabeza corta': 'Bíceps Cabeza Corta',
    'bíceps cabeza larga': 'Bíceps Cabeza Larga',
    'biceps cabeza larga': 'Bíceps Cabeza Larga',
    'tríceps cabeza larga': 'Tríceps Cabeza Larga',
    'triceps cabeza larga': 'Tríceps Cabeza Larga',
    'tríceps cabeza lateral': 'Tríceps Cabeza Lateral',
    'triceps cabeza lateral': 'Tríceps Cabeza Lateral',
    'tríceps cabeza medial': 'Tríceps Cabeza Medial',
    'triceps cabeza medial': 'Tríceps Cabeza Medial',
    'dorsales': 'Dorsales',
    'lumbares': 'Lumbares',
    'trapecios': 'Trapecios',
    'knees': 'Rodillas',
