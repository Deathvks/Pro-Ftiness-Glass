                ...
                >
                  ...
                  <div className="space-y-2 pl-2 border-l-2 border-glass-border ml-1">
                    {sets.map((set, i) => (
                      <div
                        key={`${dateKey}-${i}`}
                        className="group flex items-center justify-between rounded-xl px-4 py-3 bg-bg-secondary border border-transparent hover:border-glass-border transition-all duration-200 ml-2 cursor-default shadow-sm"
                      >
                        ...
                        <div className="flex flex-col gap-1 items-end shrink-0">
                          {set.is_warmup && (
                            <span className="bg-orange-500/10 text-orange-500 text-[10px] font-bold px-2 py-1 rounded-md flex items-center gap-1 border border-orange-500/20">
                              <Flame size={10} strokeWidth={2.5} /> C
                            </span>
                          )}
                          {set.is_dropset && (
