...
const BADGES_MAP = {
    ...
    'milestone_10': { name: 'Plata (Lvl 10)', icon: '🥈' },
    'milestone_20': { name: 'Oro (Lvl 20)', icon: '🥇' },
    'milestone_30': { name: 'Platino (Lvl 30)', icon: '🌟' },
    'milestone_40': { name: 'Diamante (Lvl 40)', icon: '💎' },
    'milestone_50': { name: 'Maestro (Lvl 50)', icon: '⚡' },
    'milestone_60': { name: 'Gran Maestro (Lvl 60)', icon: '🔥' },
    'milestone_70': { name: 'Épico (Lvl 70)', icon: '👑' },
    'milestone_80': { name: 'Leyenda (Lvl 80)', icon: '✨' },
    'milestone_90': { name: 'Mítico (Lvl 90)', icon: '🔱' },
    'milestone_100': { name: 'Inmortal (Lvl 100)', icon: '♾️' },
