  ...
  return (
    <div className="fixed inset-0 z-[110] bg-bg-primary overflow-y-auto custom-scrollbar">
      ...
      <div className="w-full max-w-4xl mx-auto p-4 sm:p-6 lg:p-8 animate-[fade-in_0.5s_ease-out]">
        ...
        <button 
          onClick={() => navigate(-1)} 
          className="flex items-center text-text-secondary hover:text-text-primary mb-6 transition-colors group"
        >
          <div className="p-2 rounded-full bg-bg-secondary group-hover:bg-bg-tertiary transition-colors mr-2">
        ...
        <GlassCard className="p-6 sm:p-8">
          ...
          <div className="space-y-4 text-text-primary text-sm sm:text-base">
            ...
            <h2 className="text-lg sm:text-xl font-semibold text-text-primary mt-6">1. Uso y Responsabilidad</h2>
            ...
            <h2 className="text-lg sm:text-xl font-semibold text-text-primary mt-6">2. Privacidad y Datos</h2>
            <p className="text-text-secondary">
            ...
            <h2 className="text-lg sm:text-xl font-semibold text-text-primary mt-6">3. Modificaciones</h2>
            <p className="text-text-secondary">
