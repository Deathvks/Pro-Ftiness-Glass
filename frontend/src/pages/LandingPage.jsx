...
const GymBot = ({ isDocked }) => (
    <div
        ...
        className={`fixed z-30 transition-all duration-1000 ease-[cubic-bezier(0.34,1.56,0.64,1)] pointer-events-none origin-right transform-gpu will-change-transform
            ${isDocked
                ? 'top-1/2 -translate-y-1/2 right-8 sm:right-10 lg:right-10 scale-[0.25] sm:scale-[0.40] opacity-20 sm:opacity-40' // MODIFICADO: right-8 para dar más margen al brazo
                : 'top-[22%] sm:top-[25%] right-16 sm:right-16 lg:right-24 scale-75 sm:scale-100 opacity-100'
            }
        `}
    >
        <style>{`
        ...
        >
            <div className="w-full h-full relative animate-[bounce_4s_infinite_ease-in-out] group-hover:[animation-play-state:paused] transform-gpu">
                ...
                <div
                    className={`absolute inset-4 rounded-[2.5rem] flex flex-col items-center justify-center z-20 transition-all duration-500 group-hover:scale-105 group-hover:opacity-100
    ...
    return (
        <div className="absolute inset-0 z-[100] bg-bg-primary overflow-hidden">
            ...
            <div
                ...
                className="absolute inset-0 z-10 text-text-primary overflow-y-auto overflow-x-hidden font-sans custom-scrollbar scroll-smooth"
