    ...
    <SafeAreaView style={styles.safeArea}>
      <ScrollView style={styles.container} contentContainerStyle={{ paddingBottom: 100 }} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.trackersRow}>
          <TouchableOpacity style={styles.trackerCard} onPress={() => alert('Abrir agua')}>
          ...
          <TouchableOpacity style={styles.trackerCard} onPress={() => alert('Abrir creatina')}>
            <View style={styles.trackerHeader}>
              <Beef color={hasCreatine ? '#a78bfa' : '#888'} size={24} />
        ...
        <View style={styles.section}>
          <View style={styles.sectionHeader}>
            <View style={{flexDirection: 'row', alignItems: 'center'}}>
                <Zap color="#3b82f6" size={24} style={{marginRight: 8}} />
          ...
          <View style={styles.cardioGrid}>
            ...
            <TouchableOpacity style={styles.cardioBtn} onPress={() => handleQuickCardio('Bici')}>
              <View style={styles.cardioIconWrapper}>
                <ActivityIcon size={28} color="#3b82f6" />
              </View>
...
const styles = StyleSheet.create({
  ...
  levelCard: { backgroundColor: '#111', padding: 24, borderRadius: 24, marginBottom: 30 },
  ...
  macroCard: { flexDirection: 'row', alignItems: 'center', backgroundColor: '#111', padding: 16, borderRadius: 20, marginRight: 15, minWidth: 160 },
  macroValue: { color: '#fff', fontSize: 20, fontWeight: 'bold' },
  macroLabel: { color: '#888', fontSize: 12 },
  trackersRow: { flexDirection: 'row', justifyContent: 'space-between', marginBottom: 20, marginTop: 10 },
  ...
  creatineStatusActive: { backgroundColor: '#a78bfa' },
