...
export const PixabayModal: React.FC<PixabayModalProps> = ({ visible, onClose, onSelectImage }) => {
  ...
  return (
    <Modal visible={visible} animationType="slide" transparent>
      <BlurView intensity={theme === 'oled' ? 50 : 80} tint={['light', 'ocean', 'desert'].includes(theme) ? 'systemUltraThinMaterialLight' : 'systemUltraThinMaterialDark'} style={StyleSheet.absoluteFill}>
